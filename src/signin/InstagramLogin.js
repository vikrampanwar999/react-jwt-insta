...
class InstagramLogin extends Component {
  ...
  onBtnClick() {
    ...
    // this.props.history.redirect(`https://api.instagram.com/oauth/authorize/?app_id=${clientId}&redirect_uri=${redirectUri}&scope=${scope}&response_type=${responseType}`
    //);
  }
...
InstagramLogin.propTypes = {
  ...
  otherProps: PropTypes.oneOfType([
    PropTypes.arrayOf(PropTypes.node),
    PropTypes.node
]),
accessTkn:PropTypes.string
}
